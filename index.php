                ...
                while ($row = mysqli_fetch_array($run_query)) {
                    echo '<script> 
                            var obj = {
                                id: ' . $row['pId'] . ',
                                name: "' . $row['name'] . '",
                                descri : \'' . $row['description'] . '\'.substr(0, 150) + "...",
                                price: ' . $row['price'] . '
                            }; 
                            arr.push(obj);
                        </script>';
                ...
                for (let i = page; i < page + 6; i++) {
                    if (i < arr.length) {
                        document.getElementById('AllProd').innerHTML += '<div class="mb-10"><a class="relative block" href="/ecommerce/product.php?id=' +
                            ...
                            '</p></div></div></a><button onclick="" class="w-full rounded-b-2xl p-3 text-xs tracking-wide text-center text-white uppercase bg-indigo-800 hover:bg-indigo-600" type="button">Add to Cart</button></div>';
                    }
                }
            </script>
